...
"""Renders the final wrist_camera and top_camera exactly as configured in
pickplace_scene.py (16:9 aspect ratio matching the real cameras) -- a
sanity check after any resolution/aspect change, no candidate sweeping.

Usage:
    ./isaaclab.sh -p /path/to/capture_final_cameras.py --headless --enable_cameras
"""
...
parser.add_argument(
    "--output-dir", type=str, default="/home/keerthan/SO-101-WM/sim/output/final_cameras", help="Output dir."
)
...
def main():
    ...
    sim.render()
    for name in ["wrist_camera", "top_camera"]:
        cam = scene[name]
